...
'****************************************************************************
    ...
    With m_PicRect
        ...
        If LenB(m_Caption) > 0 And m_PictureAlign <> epBackGround Then
...
'Called on designtime everytime a control is added
    ...
    m_ButtonStyle = eVistaAero   'As all the commercial buttons initialize with this them, ;)
    m_bShowFocus = True
    m_bEnabled = True
...
Public Property Set Font(ByVal New_Font As StdFont)
    ...
    Call mFont_FontChanged(vbNullString)
